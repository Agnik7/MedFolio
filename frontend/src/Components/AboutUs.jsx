  ...
  return (
    <section id="about">
      <div className="flex flex-row justify-between items-start gap-5 flex-wrap-reverse md:flex-nowrap">
        <div className="flex flex-row justify-center items-center  w-full md:w-[60%] p-3">
        ...
        <div className="w-full md:w-[45%] flex flex-col justify-center items-center md:items-start gap-5 text-[#1C4C58]">
